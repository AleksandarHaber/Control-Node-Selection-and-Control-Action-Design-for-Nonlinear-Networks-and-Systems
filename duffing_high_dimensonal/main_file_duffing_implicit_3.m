...
[solution_selection(:,i),fval(i),exitflag(i),info{i}]=solve_problem_dynamic_ti_fsolve_3_relaxed(time_steps,x0,xd,h,solution_initial_selection(:,i),no_control_nodes,@duffing_network_dynamics,@duffing_network_dynamics_gradient);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%        verify the results by randomly selecting control nodes
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[~,no_control_nodes_2]=size(Bmatrix_reduced)
for i=1:500
i
ss = sort(randsample(N,no_control_nodes_2));
Brandom=zeros(2*N,no_control_nodes_2);
for j=1:no_control_nodes_2
    Brandom(2*ss(j),j)=1;
end

solution_random=solve_problem_dynamic_unconstrained_ti_3(time_steps,x0,xd,h,Brandom,randn(time_steps*no_control_nodes_2,1),@duffing_network_dynamics,@duffing_network_dynamics_gradient);
% compute the response for the calculated control inputs
