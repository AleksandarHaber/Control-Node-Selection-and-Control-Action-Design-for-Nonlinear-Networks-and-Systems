...
function [solution,fval,exitflag,info]=solve_problem_dynamic_ti_fsolve_3(time_steps,x0,xd,h,initial_solution,no_control_nodes,fcnHandle,fcnHandleGradient)
...
function cost_function_value_dynamic = cost_function_dynamic(z)
    ...
    options_fsolve = optimoptions('fsolve','Algorithm', 'trust-region','Display','off','SpecifyObjectiveGradient',true,'UseParallel',true,'FunctionTolerance',1.0000e-12,'MaxIter',10000,'StepTolerance', 1.0000e-12);
